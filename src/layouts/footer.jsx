...
export const Footer = () => {
  return (
    <div className="bg-[#f0f0f0] py-14 px-11">
      ...
      <p className="text-center pt-10 cursor-pointer text-gray-500">Copyright © 2022 <span className="duration-300 hover:text-red-500">Shopify Theme Developed by MassTechnologist</span> All rights reserved.</p>
    </div>
  );
};
