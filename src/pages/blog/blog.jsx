      ...
      <div className=" flex flex-col md:flex-row mt-[50px]">
        <div className=" w-full md:w-[70%] flex flex-col gap-y-[30px] justify-center items-center">
          <div className="relative h-[700px] w-[75%] overflow-hidden">
            <div className="absolute inset-0 blog2 bg-cover bg-center hover:scale-[1.05] hover:duration-300"></div>
          </div>
        ...
        <div className=" w-full md:w-[30%] flex justify-start items-start flex-col">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex mt-[50px]">
              <div className="gl1 bg-cover bg-center h-[100px] w-[70px] hover:opacity-[0.7] hover:duration-150"></div>
              <div className="pl-5">
            ...
            <div className="flex ">
              <div className="gl2 bg-cover bg-center h-[100px] w-[70px] hover:opacity-[0.7] hover:duration-150"></div>
              <div className="pl-5">
                <div className="font-thin">
                  Boxy7 T-Shirt with <br /> Roll Sleeve
                </div>
            ...
            <div className="flex ">
              <div className="gl3 bg-cover bg-center h-[100px] w-[70px] hover:opacity-[0.7] hover:duration-150 "></div>
              <div className="pl-5">
                <div className="font-thin">
                  Boxy7 T-Shirt with <br /> Roll Sleeve
                </div>
            ...
            <div className="flex ">
              <div className="gl4 bg-cover bg-center h-[100px] w-[70px] hover:opacity-[0.7] hover:duration-150 "></div>
              <div className="pl-5">
                <div className="font-thin">
                  Boxy7 T-Shirt with <br /> Roll Sleeve
                </div>
            ...
            <div className="flex ">
              <div className="gl5 bg-cover bg-center h-[100px] w-[70px] hover:opacity-[0.7] hover:duration-150 "></div>
              <div className="pl-5">
                <div className="font-thin">
                  Boxy7 T-Shirt with <br /> Roll Sleeve
                </div>
      ...
      <div className="py-10 flex flex-col md:flex-row mt-[50px]">
        <section className=" w-full md:w-[70%] flex flex-col gap-y-[30px] justify-center items-center">
          <div className="relative h-[600px] w-[70%] overflow-hidden">
            <div className="absolute inset-0 blog3 bg-cover bg-center hover:scale-[1.05] hover:duration-300"></div>
          </div>
          <div className="w-[70%] flex flex-col gap-[20px]">
            <h2 className="font-bold text-2xl hover:text-[#e65540] hover:duration-300">
